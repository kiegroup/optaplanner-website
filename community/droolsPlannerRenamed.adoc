...
http://www.optaplanner.org[Visit www.optaplanner.org for an explanation.]
...
* OptaPlanner has graduated from the http://www.drools.org[Drools] project to become a top-level http://www.jboss.org/[JBoss Community] project.
...
http://www.optaplanner.org[Visit www.optaplanner.org to learn more about OptaPlanner.]
