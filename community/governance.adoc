...
The project lead will then publish the roadmap on link:questions.html[the developer mailing list],
...
and posting to link:../product/services.html[the community forum], is a great way to express interest as well.
