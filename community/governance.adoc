...
The project lead will then publish the roadmap on link:forum.html[the developer mailing list],
and update the version information in link:../code/issueTracker.html[JIRA].

OptaPlanner is the basis for the commercial (yet open source) link:product.html[BRMS and BPM Suite products],
