...
https://github.com/droolsjbpm/optaplanner/tree/master/optaplanner-docs/src/main/docbook/en-US/images/Chapter-Planner_introduction[in this GitHub directory].
