...
Instead it will be 9.36.0.Final, to go along with 8.36.0.Final.
...
For the vast majority of our users, we believe that switching to OptaPlanner 9 will require just a single line change in your Maven or Gradle build files.

// TODO insert Maven snippet
...
However, we have created tooling to simplify this transition to a point where it is also a single line of code.

// TODO insert OpenRewrite snippet
...
We would appreciate if you could try to migrate your projects to the 9.35.0.Alpha3 version we've released to day.
If you run into any issues, https://www.optaplanner.org/community/getHelp.html[reach out to us] and let us know.