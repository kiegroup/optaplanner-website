...
If you're still using `SimpleDoubleScore` or `HardSoftDoubleScore` in your codebase, refactor your planning solution and your scoring function to use another score type.
