...
It also make it easier to switch the score weight or score level on a tenant by tenant basis.
In future versions, it will also making unit testing easier and potentially provide build-in support for simulations.
