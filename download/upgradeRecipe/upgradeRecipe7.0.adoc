...
If you're encountering any of these, check link:./[the previous upgrade recipes] on how to change your code.
...
Inside a `ScoreCalculator`, it must be passed from the `calculateScore()` method (see above).
