= Release Notes 6.1
:awestruct-description: New and noteworthy, demos and status for OptaPlanner 6.1.
:awestruct-layout: releaseNotesBase
:awestruct-priority: 1.0

== OptaPlanner 6.1 announcement
...
just follow link:../upgradeRecipe/upgradeRecipe6.1.html[the upgrade recipe].

== Archive

For older releases, check link:./[the release notes archive].
