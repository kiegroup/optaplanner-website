...
you to easily test your link:https://docs.optaplanner.org/latestFinal/optaplanner-docs/html_single/index.html#constraintStreams[ConstraintProvider constraints].
...
domain accessors and solution cloners but come with some
restrictions.
