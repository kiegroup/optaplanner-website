...
== What is OptaPlanner 8?

*OptaPlanner 8 is basically OptaPlanner 7 without the deprecated methods*
and a few minor backwards incompatible changes.
**Migrating your code from 7 to 8 is easy and quick.**
...
contains beautiful web demo's for multiple use cases.
