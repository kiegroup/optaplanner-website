...
All users of OptaPlanner are discouraged from using these APIs in their projects, and we encourage everyone to check out our link:../upgradeRecipe/upgradeRecipe7.html[updated upgrade recipe] and adapt.
