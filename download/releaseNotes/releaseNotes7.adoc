...
=== Several major API deprecations

With this release, we are announcing several major API deprecations.
All users of OptaPlanner are discouraged from using these APIs in all projects current and new, and we encourage everyone to check out our link:../upgradeRecipe/upgradeRecipe7.html[updated upgrade recipe] and adapt.
