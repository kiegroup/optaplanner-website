...
The constraint streams API continued to evolve, gaining support for https://docs.optaplanner.org/latestFinal/optaplanner-docs/html_single/index.html#constraintStreamsConditionalPropagation[conditional propagation].
