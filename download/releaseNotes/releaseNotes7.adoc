...
== New and noteworthy: Engine 7.44.0.Final

=== Deprecated JavaScript support in configuration

In this release, we have deprecated the rarely used ability to specify thread pool sizes using JavaScript expressions.
...
Furthermore, users who wish to continue to use JavaScript configuration together with JDK 15 or later will have to add
the following dependency to their runtime, on account of the OpenJDK project
