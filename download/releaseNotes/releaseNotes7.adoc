...
The `optaplanner-webexamples` module was removed from distribution and the Git repository. It has been superseded by
https://github.com/kiegroup/optaweb-vehicle-routing[OptaWeb Vehicle Routing].
