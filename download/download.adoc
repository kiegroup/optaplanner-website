...
** link:upgradeRecipe/upgradeRecipe#{site.pom.latestFinal.releaseNotesVersion}.html[Upgrade recipe for #{site.pom.latestFinal.releaseNotesVersion}]
...
** link:upgradeRecipe/upgradeRecipe#{site.pom.latest.releaseNotesVersion}.html[Upgrade recipe for #{site.pom.latest.releaseNotesVersion}]
** License: link:../code/license.html[ASL 2.0]
