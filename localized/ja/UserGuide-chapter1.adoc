...
image::http://docs.optaplanner.org/latest/optaplanner-docs/html_single/images/Chapter-Planner_introduction/optaPlannerLogo.png[]
...
image::http://docs.optaplanner.org/latest/optaplanner-docs/html_single/images/Chapter-Planner_introduction/useCaseOverview.png[]
...
image::http://docs.optaplanner.org/latest/optaplanner-docs/html_single/images/Chapter-Planner_introduction/whatIsAPlanningProblem.png[]
...
// image::http://docs.optaplanner.org/latest/optaplanner-docs/html_single/images/Chapter-Planner_introduction/compatibility.png[] //
...
// image::http://docs.optaplanner.org/6.4.0.Final/optaplanner-docs/html_single/images/Chapter-Planner_introduction/distributionZip.png[] //
image:http://docs.optaplanner.org/6.4.0.Final/optaplanner-docs/html_single/images/Chapter-Planner_introduction/distributionZip.png[]

サンプル GUI アプリケーションが開きます。サンプルを一つ選択してください。

image::http://docs.optaplanner.org/6.4.0.Final/optaplanner-docs/html_single/images/Chapter-Planner_introduction/plannerExamplesAppScreenshot.png[]
...
image::http://docs.optaplanner.org/6.4.0.Final/optaplanner-docs/html_single/images/Chapter-Planner_introduction/kieFunctionalityOverview.png[]

Drools を用いたオプションの統合についてより多く知るには、link:http://docs.optaplanner.org/6.4.0.Final/optaplanner-docs/html_single/index.html#architectureOverview[構造の概要]を参照してください。
