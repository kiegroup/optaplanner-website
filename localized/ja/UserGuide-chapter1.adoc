...
// image::http://docs.jboss.org/optaplanner/release/6.4.0.Final/optaplanner-docs/html_single/images/Chapter-Planner_introduction/distributionZip.png[] //
image:images/Chapter-Planner_introduction/distributionZip.png[]

サンプル GUI アプリケーションが開きます。サンプルを一つ選択してください。

image::http://docs.jboss.org/optaplanner/release/6.4.0.Final/optaplanner-docs/html_single/images/Chapter-Planner_introduction/plannerExamplesAppScreenshot.png[]
...
image::http://docs.jboss.org/optaplanner/release/6.4.0.Final/optaplanner-docs/html_single/images/Chapter-Planner_introduction/kieFunctionalityOverview.png[]

Drools を用いたオプションの統合についてより多く知るには、link:http://docs.jboss.org/optaplanner/release/6.4.0.Final/optaplanner-docs/html_single/index.html#architectureOverview[構造の概要]を参照してください。
