...
um Produkte un Dienste dem Kunden zu liefern.
OptaPlanner optimiert solche Planungsprobleme um **mehr Business mit weniger Ressourcen** zu machen.
Zu Anwendungsfälle gehören [Tourenplanung](learn/useCases/vehicleRoutingProblem.html), Arbeiter Dienstplanung, Aufgaben Zeitplanung,
...
OptaPlanner ist **Open Source Software**, veröffentlicht unter [der Apache Software Lizenz](code/license.html).
Es ist in 100% pur Java™ geschrieben, läuft auf jeder JVM und ist auch in [der Maven Central Repository](download/download.html) erhältlich.
...
(published in http://www.sigs-datacom.de/fachzeitschriften/javaspektrum.html[JavaSPEKTRUM])
and http://jaxenter.de/artikel/jboss-optaplanner-optimierung-2-0-176855[Optimierung 2.0]
(published in https://jaxenter.de/Java-Magazin-215-178070[Java Magazin 2.15])
