...
function insertEmailSupportPopover() {
    $('.emailSupportPopover').each(function(idx, node) {
        $(node).popover({
            ...
            content: '<p>Please do not contact our developers directly for free support, use <a href="./getHelp.html">StackOverflow</a> or <a href="../product/services.html">paid enterprise support</a> instead.</p>'
