...
. Download https://github.com/kiegroup/optaplanner-website/tree/master/assets/learn/slides/[the source of these HTML slides].
    ...
    ** To edit the images, look for the `svg` source files
    in https://github.com/kiegroup/optaplanner/tree/master/optaplanner-docs[optaplanner-docs]
