...
4. Set _testFileName_ in https://github.com/kiegroup/optaplanner/blob/main/optaplanner-examples/src/main/test/java/org/optaplanner/examples/conferencescheduling/solver/ConferenceSchedulingConstraintsXlsxTest.java[ConferenceSchedulingConstraintsXlsxTest] and run the test file.
