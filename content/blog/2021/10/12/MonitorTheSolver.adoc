...
. Click the clock icon in the top right, and select "Last 15 minutes" under "Relative time range". This make the dashboard show data that occurred during the past 15 minutes.
