...
Together with the Quarkus and Kogito projects, we have raised the minimum required version of the Java Platform to 11.
OpenJDK is an open source Java implementation and is https://adoptopenjdk.net/[free to download].

OptaPlanner 8.10.0.Final also works flawlessly with the current OpenJDK release, which is OpenJDK 16.
