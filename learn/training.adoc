...
Follow https://learn.openshift.com/middleware/courses/middleware-kogito/optaplanner-knapsack[this KataKoda]
to quickly learn:

* How to solve a _knapsack problem_ with OptaPlanner.
* How to expose it as a REST application on Quarkus.
* How deploy that application in the cloud on OpenShift.
