...
:blogpost-imagesdir: #{relative('/blog/2013/10/11/', page)}
...
image:{blogpost-imagesdir}/skynet1.png[]
...
image:{blogpost-imagesdir}/skynet2.png[]
...
image:{blogpost-imagesdir}/skynet3.png[]
