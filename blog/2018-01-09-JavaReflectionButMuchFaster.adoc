...
Some critics also correctly pointed out that the original benchmark didn't use static fields correctly,
...
That's only 33% slower than direct access. I welcome this option.
