...
:blogpost-imagesdir: #{relative('/blog/2013/08/16/', page)}
...
image:{blogpost-imagesdir}/vrpPresumptions01.png[]
...
image:{blogpost-imagesdir}/vrpPresumptions02.png[]
...
image:{blogpost-imagesdir}/vrpPresumptions03.png[]
...
image:{blogpost-imagesdir}/vrpPresumptions04.png[]
...
image:{blogpost-imagesdir}/vrpPresumptions05.png[]
...
image:{blogpost-imagesdir}/vrpPresumptions06.png[]
...
image:{blogpost-imagesdir}/vrpPresumptions07.png[]
...
image:{blogpost-imagesdir}/vrpPresumptions08.png[]
...
image:{blogpost-imagesdir}/vrpPresumptions09.png[]
...
image:{blogpost-imagesdir}/vrpPresumptions10.png[]

Given these requirements, we need to focus on the capacity and the time windows _in parallel_:

image:{blogpost-imagesdir}/vrpPresumptions11.png[]
...
image:{blogpost-imagesdir}/vrpPresumptions12.png[]
