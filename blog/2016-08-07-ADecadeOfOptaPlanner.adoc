...
It is used across the world to create better logistic schedules, such as http://www.optaplanner.org/learn/useCases/employeeRostering.html[employee rosters],
http://www.optaplanner.org/learn/useCases/vehicleRoutingProblem.html[vehicle routes] and http://www.optaplanner.org/learn/useCases/cloudOptimization.html[cloud distributions].
