...
let's look at how both algorithm scale. First on N queens:
...
Exhaustive algorithms don't scale. Use the other algorithms in http://www.optaplanner.org[OptaPlanner],
