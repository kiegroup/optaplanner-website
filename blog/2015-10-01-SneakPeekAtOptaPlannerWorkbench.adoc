...
+++
<iframe width="853" height="480" src="https://www.youtube.com/embed/XB1_juPoWiU?rel=0" frameborder="0" allowfullscreen></iframe>
+++
...
OptaPlanner Workbench is build on top of the OptaPlanner engine, but it will not replace it, nor curtail it:
