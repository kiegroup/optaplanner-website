...
:awestruct-tags: [activemq, quarkus, integration]
:awestruct-share_image_filename: activemqSolvingArchitecture.png
...
The source code is available in the https://github.com/kiegroup/optaplanner-quickstarts/tree/stable/activemq-quarkus-school-timetabling[activemq-quarkus-school-timetabling quickstart], along with the other https://github.com/kiegroup/optaplanner-quickstarts[optaplanner-quickstarts].
...
. cd optaplanner-quickstarts/activemq-quarkus-school-timetabling
. ./run.sh
