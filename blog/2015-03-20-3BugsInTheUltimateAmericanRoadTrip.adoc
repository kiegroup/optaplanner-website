...
http://docs.optaplanner.org/6.2.0.Final/optaplanner-docs/html_single/images/Chapter-Use_cases_and_examples/roadDistanceTriangleInequality.png[Here's my elaborate proof of that.]
