...
The enables you to implement all constraints: none will be out reach.
...
So allow to user to change the score weights at runtime and quickly see the effect of his/her changes on the solution.
