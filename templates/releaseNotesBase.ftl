...
<@parent.layout>
    ...
    <div class="paragraph summaryParagraph">
        <p>We are happy to announce a ${content.release_notes_version} <strong>${content.release_notes_version_qualifier}</strong> release of <a href="https://www.optaplanner.org">OptaPlanner</a>.
            OptaPlanner is a lightweight, embeddable planning engine written in Java™ to solve AI constraint optimization problems efficiently.
            Use cases include <a href="${content.rootpath}learn/useCases/vehicleRoutingProblem.html">Vehicle Routing</a>,
            ...
            <a href="${content.rootpath}learn/useCases/conferenceScheduling.html">Conference Scheduling</a> and many more.</p>
    </div>

<div class="row" style="margin-bottom: 10px;">
    <div class="col-md-6">
        <div class="text-center"><a class="btn btn-lg btn-success versionedButton" href="${releaseNotesAreFinal?then(pom.latestFinal.distributionZip, pom.latest.distributionZip)}">
    ...
    <div class="col-md-6">
        <div class="text-center"><a class="btn btn-lg btn-primary versionedButton" href="${releaseNotesAreFinal?then(pom.latestFinal.engineDocumentationHtmlSingle, pom.latest.engineDocumentationHtmlSingle)}">
...
<div class="row">
    ...
    <div class="col-md-6">
        TODO productToProjectVersionMapping
        ...
        <div class="sectionbody">
            <div class="paragraph">
                <p>The best and easiest way to upgrade to this new version of OptaPlanner is by following
                    <a href="${content.rootpath}upgradeRecipe/upgradeRecipe${content.release_notes_version}.html">the upgrade recipe</a>.</p>
            </div>
        </div>
    </div>
    <div class="sect1">
        ...
        <div class="sectionbody">
            <div class="paragraph">
                <p>Read <a href="./">the previous release notes</a> to learn about the new and noteworthy in previous releases.</p>
            </div>
        </div>
    </div>
</@parent.layout>
